    ...
    return (
      <div className="min-vh-100 position-relative pt-5">
        ...
        <div className="d-flex justify-content-center align-items-center min-vh-100">
          <Spinner animation="border" role="status" variant="primary" className="fs-3">
                ...
                <Row className="g-4">
                  <Col sm={6} md={4}>
                    <div className="d-flex flex-column">
                      <small className="text-light opacity-75">Release Date</small>
                    ...
                    <Card.Body className="d-flex flex-column">
                      <div className="text-center mb-3">
                        {cast.artist.thumb ? (
                          ...
                          <div className="rounded-circle bg-secondary d-flex align-items-center justify-content-center mx-auto" style={{ width: 100, height: 100 }}>
