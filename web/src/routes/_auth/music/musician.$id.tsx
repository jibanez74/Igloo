        ...
        <div className="flex min-w-0 flex-1 flex-col text-center md:text-left">
          ...
          >
            <li className="flex items-center gap-1.5">
              <Disc3 className="size-4 text-slate-500" aria-hidden="true" />
              <span>
          ...
          {(spotifyPopularity !== null || spotifyFollowers !== null) && (
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-slate-500 sm:text-sm md:justify-start">
