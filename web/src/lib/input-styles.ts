...
export const lightInputPeerHoverClassName =
  "peer-hover:bg-slate-100/95 peer-hover:text-slate-950 " +
  "dark:peer-hover:bg-white/10 dark:peer-hover:text-slate-50";
