      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="mt-4 flex items-center gap-2">
          <Link
            ...
            className={cn(
              MOTION_MICRO_COLORS_CLASS,
              "inline-flex h-9 items-center rounded-md bg-primary px-3 text-xs font-semibold text-primary-foreground hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none",
            )}
