...
export default function WatchRooms() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 rounded-2xl border border-primary/20 bg-linear-to-br from-primary/10 via-card to-background p-5 shadow-[0_20px_60px_-40px_rgba(245,158,11,0.55)]">
