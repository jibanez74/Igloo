...
CREATE TABLE
  IF NOT EXISTS movies (
    ...
    run_time INTEGER,
    duration REAL,
    user_locked_title BOOLEAN NOT NULL DEFAULT false,
    user_locked_tmdb_id BOOLEAN NOT NULL DEFAULT false,
    user_locked_imdb_id BOOLEAN NOT NULL DEFAULT false,
    user_locked_poster_path BOOLEAN NOT NULL DEFAULT false,
    user_locked_backdrop_path BOOLEAN NOT NULL DEFAULT false,
    user_locked_adult BOOLEAN NOT NULL DEFAULT false,
    user_locked_language BOOLEAN NOT NULL DEFAULT false,
    user_locked_year BOOLEAN NOT NULL DEFAULT false,
    user_locked_release_date BOOLEAN NOT NULL DEFAULT false,
    user_locked_overview BOOLEAN NOT NULL DEFAULT false,
    user_locked_tag_line BOOLEAN NOT NULL DEFAULT false,
    user_locked_certification BOOLEAN NOT NULL DEFAULT false,
    user_locked_critic_rating BOOLEAN NOT NULL DEFAULT false,
    user_locked_audience_rating BOOLEAN NOT NULL DEFAULT false,
    user_locked_revenue BOOLEAN NOT NULL DEFAULT false,
    user_locked_budget BOOLEAN NOT NULL DEFAULT false,
    user_locked_run_time BOOLEAN NOT NULL DEFAULT false,
    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
  );
