...
VALUES
  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
RETURNING id, tmdb_key, immich_base_url, immich_api_key, jellyfin_base_url, jellyfin_api_key, spotify_client_id, spotify_client_secret, audiodb_api_key, fanart_tv_api_key, music_metadata_enabled, hardware_acceleration_device, enable_watcher, download_images, movies_dir, shows_dir, music_dir, server_upload_mbps, static_dir, transcode_dir, created_at, updated_at
`
...
SELECT
  id, tmdb_key, immich_base_url, immich_api_key, jellyfin_base_url, jellyfin_api_key, spotify_client_id, spotify_client_secret, audiodb_api_key, fanart_tv_api_key, music_metadata_enabled, hardware_acceleration_device, enable_watcher, download_images, movies_dir, shows_dir, music_dir, server_upload_mbps, static_dir, transcode_dir, created_at, updated_at
FROM settings
ORDER BY id
LIMIT 1
`
