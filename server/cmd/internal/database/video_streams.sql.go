...
RETURNING id, created_at, updated_at, title, video_index, duration, profile, aspect_ratio, bit_rate, bit_depth, codec, width, height, coded_width, coded_height, color_transfer, color_primaries, color_space, color_range, frame_rate, avg_frame_rate, level, movie_id
`
...
SELECT id, created_at, updated_at, title, video_index, duration, profile, aspect_ratio, bit_rate, bit_depth, codec, width, height, coded_width, coded_height, color_transfer, color_primaries, color_space, color_range, frame_rate, avg_frame_rate, level, movie_id FROM video_streams
WHERE movie_id = $1
