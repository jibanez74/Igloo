...
func New() MusicBrainzInterface {
  return &musicBrainzClient{
    httpClient:     &http.Client{Timeout: 10 * time.Second},
    userAgent:      helpers.MUSICBRAINZ_USER_AGENT,
    baseURL:        helpers.MUSICBRAINZ_BASE_URL,
    audioDBBaseURL: helpers.AUDIODB_BASE_URL,
    audioDBAPIKey:  helpers.AUDIODB_API_KEY,
