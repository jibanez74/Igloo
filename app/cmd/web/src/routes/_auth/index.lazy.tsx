...
function HomePage() {
  return (
    <>
      ...
      <title>Home - Igloo</title>
      <meta name="description" content="Welcome to Igloo - explore your personal media library with recently added movies, TV shows, music, and more." />
