...
function AlbumDetailsContent({
  ...
  const handleDeleteAlbum = async () => {
    ...
    try {
      ...
      if (result.error) {
        showActionFailed("delete album", result.message || "Unable to delete album. Please try again.");
        return;
      }

      showDeleted("Album", `"${album.title}" has been removed from your library.`);
      ...
      showActionFailed("delete album", "An unexpected error occurred. Please try again.");
    } finally {
      setIsDeleting(false);
