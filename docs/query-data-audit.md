...
| `RecordMovieTmdbMiss` | 0 → 0 | None | No returned row to trim. Records a definitive TMDB miss (attempt count and time) for the no-match backoff. [persistence.go](../server/cmd/internal/scanner/movie/persistence.go) |
